...
const Weather = props => {
    ...
    return (
        <div className="col s12 m6" style={{marginTop: "12px"}}>
            <div className="card hoverable">
                ...
                <div className="card-action">
                    <div className="row align-detail">
                        <ForecastItem label={"Umidity"} value={weather.main.humidity} simbol={"%"}/>
                        <ForecastItem label={"Pressure"} value={weather.main.pressure} simbol={"hPa"}/>
                        <ForecastItem label={"Wind"} value={weather.wind.speed} simbol={"km/h"}/>
                    </div>
                </div>
            </div>
        </div>
